...
export async function createNewOrder(data: z.infer<typeof createOrderDTO>, chair: z.infer<typeof EditChairDTO>, table: z.infer<typeof EditTableDTO>, chairCount: number, tableCount: number) {
  try {
